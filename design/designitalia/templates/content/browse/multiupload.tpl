...
<div class="u-padding-bottom-l u-cf">
    <form class="pull-right" name="browse" method="post" action={$browse.from_page|ezurl}>
        <input class="Button Button--danger" type="submit" name="BrowseCancelButton" value="Esci"/>
    </form>
...
<div class="Grid Grid--withGutter u-padding-bottom-l">
        ...
        <form class="u-padding-bottom-l" name="browse" method="post" action={$browse.from_page|ezurl}>
            ...
            <div class="panel panel-default">
                ...
                {if $browse.start_node|gt( 1 )}
                    <div class="panel-heading u-padding-top-l u-padding-bottom-l">
